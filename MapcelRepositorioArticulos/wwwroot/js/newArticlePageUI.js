...
const NewArticlePageUI = (function () {
    ...
    function initializeEditor() {
        ...
        return ensureCkEditorAssetsLoaded()
            .then(function () {
                ...
                const LICENSE_KEY =
                    'eyJhbGciOiJFUzI1NiJ9..C1FMHkBqWrXhpR_oxI82HAFlGTVixGigU6mwktkcOfZuxaclsZ4e-zjYEJx2N_Xe56dXUcaIB6h9h95pW5Q6kA';
    ...
    function handleSubmit() {
        ...
        return Promise.resolve()
            .then(function () {
                let descriptionHtml = sanitizeEditorHtml(pageState.editorInstance.getData());
